...
class UrlConfig
{
	 ...
	 */
	//快速注册企业小程序
	public const fastregisterweapp = self::baseUrl . "/cgi-bin/component/fastregisterweapp?component_access_token=";
	//复用公众号主体快速注册小程序
	public const fastregister      = self::baseUrl . "/cgi-bin/account/fastregister?access_token=";
	//快速注册个人小程序
	public const fastregisterpersonalweapp = self::baseUrl . '/wxa/component/fastregisterpersonalweapp?action=%1$s&component_access_token=%2$s';
	/**
	 * 试用小程序
	 */
	//创建试用小程序
